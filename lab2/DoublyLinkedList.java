 ...
 * Description: Implement two dummy nodes into the DoublyLinkedList class
 */
...
public class DoublyLinkedList<E> {
    ...
    private void insertAfter(E value, ListNode previous) {
        ...
        ListNode newNode = new ListNode(value, previous, previous.next);
